<?php session_start(); 
  ...
  if($varsession == null || $varsession == ''){
        echo '<!DOCTYPE html>
                <html lang="es">
                <head>
                <title>Calendario de Farmcias - Main</title>
                <meta charset="utf-8">
...
<html lang="es">
<head>
  <title>Calendario de Farmacias - Cambiar Estado Usuario</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <?php skeleton(); ?>
</head>
...
<div class="container"><br>
  ...
  <?php
    ...
    if($conn){
        ...
        $nUsuario->formEditarEstado($nUsuario,$id,$conn,$dbname);
...
<script type="text/javascript" src="lib_usuarios.js"></script>
</body>
</html>
